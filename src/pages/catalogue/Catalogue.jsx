    ...
    <div className="max-w-3xl space-y-6">
      <div className="bg-white rounded shadow p-6">
        ...
        <div className={`border-2 border-dashed rounded-lg p-6 text-center ${
          ...
          <p className="text-sm text-gray-600 mb-3">JPG, PNG, WEBP, PDF, ZIP — max 10 Mo</p>
          <div className="mb-3">
            <input
              type="text"
            ...
            <label className={`inline-block px-4 py-2 rounded text-sm font-medium ${
              ...
              <input
                ref={fileRef}
                type="file"
                accept="image/jpeg,image/png,image/webp,image/gif,image/heic,image/heif,application/pdf,application/zip,application/x-zip-compressed,.jpg,.jpeg,.png,.webp,.gif,.heic,.heif,.pdf,.zip"
                className="hidden"
